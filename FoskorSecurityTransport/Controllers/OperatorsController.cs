...
namespace FoskorSecurityTransport.Controllers
{
    public class OperatorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OperatorID,Name,Surname,CompanyNumber,OperatorRole,Department,Status")] Operator @operator)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OperatorID,Name,Surname,CompanyNumber,OperatorRole,Department,Status")] Operator @operator)
        {
            if (ModelState.IsValid)
            {
