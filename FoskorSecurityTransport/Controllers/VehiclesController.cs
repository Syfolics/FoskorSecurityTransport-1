...
namespace FoskorSecurityTransport.Controllers
{
    public class VehiclesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "VehicleID,RegistrationNo,Make,Model,Status")] Vehicle vehicle)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "VehicleID,RegistrationNo,Make,Model,Status")] Vehicle vehicle)
        {
            if (ModelState.IsValid)
            {
